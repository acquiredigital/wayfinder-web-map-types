declare namespace Wayfinder {
  ...
  export class Bounds {
    ...
    get box3(): import('three').Box3 | null;
     ...
     */
    combine(bounds: Bounds | import('three').Box3 | Coordinates): boolean;
     ...
     */
    combineVector(v: Coordinates | import('three').Vector3): void;
    ...
    populateFromBox3(box: import('three').Box3): void;
